...
export const FRAME_UNLOCKS = [
  ...
  },
  {
    ...
    icon:     '🎬',
    minLvl:   1,
    pngUrl:   '/images/cadres-gamification/Ciné Délices/img/cadre-cine-delices-v2.webp',
  ...
  },
  {
    ...
    icon:     '🔍',
    minLvl:   2,
    pngUrl:   '/images/cadres-gamification/Sherlock Holmes/img/cadre-sherlock-holmes-1440.webp',
  ...
  },
  {
    ...
    theme:    'Magie',
    subLabel: "L'Œil d'Agamotto",
    icon:     '✨',
    minLvl:   6,
    pngUrl:   '/images/cadres-gamification/Dr Strange/img/cadre-dr-strange.png',
    thumbUrl: '/images/cadres-gamification/Dr Strange/img/cadre-dr-strange.png',
    hasAnim:  true,
    isCssOnly: true,
  },
];

  ...
  const registerSchema = Joi.object({
    ...
    pseudo: Joi.string()
      ...
      .messages({
        ...
        'string.pattern.base': 'Le pseudo ne peut contenir que des lettres, des chiffres et des underscores.'
      }),
    ...
    password: Joi.string()
      .min(8)
      .max(255)
      .pattern(/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]+$/) // (ex: exigence de majuscules, chiffres, caractères spéciaux)
      .required()
      .messages({
